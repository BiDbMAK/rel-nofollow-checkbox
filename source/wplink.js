...
/* 
Original Copyright (c) 2014 Fábio Santos. See the LICENSE file for license rights and limitations (GPLv2).
        ...
        mceRefresh: function (searchStr, text) {
            ...
            if (linkNode.length) {
                ...
                if (href !== '_wp_link_placeholder') {
                    ...
                    inputs.noFollow.prop('checked', editor.dom.getAttrib(linkNode, 'class').indexOf('nofollow') !== -1);
